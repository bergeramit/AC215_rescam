#!/usr/bin/env python3
"""
Quick sanity check script for fine-tuned model.
Run this after fine-tuning completes to verify everything works.
"""
import os
import sys
...
def check_job_status():
    """Check if fine-tuning job completed successfully."""
    print("=" * 70)
